...
import type { Props, estComponent } from '../types';
 ...
 */
export function renderToString(component: estComponent, props?: Props): string {
 ...
 */
export function hydrate(component: estComponent, container: string | Element): void {
 ...
 */
export function ssg(component: estComponent, props?: Props): SSGNode | JSX.Element {
