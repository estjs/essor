...
describe('should work with jsx client transform', () => {
  ...
  it('transforms client JSX element with dynamic expressions', () => {
    const inputCode = `
      const name = 'John';
  ...
  it('should work with fragments and keys and values', () => {
    const inputCode = `
    const val = 'test';
  ...
  it('should work with portal components', () => {
    const inputCode = `
  ...
  it('should work with error boundaries2', () => {
    const inputCode = `
  ...
  it('should work with multiple contexts', () => {
    ...
    const cla = class {
      ...
      const element = (
        <ThemeContext.Provider value="dark">
          <UserContext.Provider value={{ name: 'John' }} v1={undefined} v2={null} v3={true} v4={false} v5={1} v6={1.1} v7={'1'} v8={Symbol('1')} v9={cla} v10={new Date()}>
  ...
  it('should work with portals and ref forwarding', () => {
    const inputCode = `
